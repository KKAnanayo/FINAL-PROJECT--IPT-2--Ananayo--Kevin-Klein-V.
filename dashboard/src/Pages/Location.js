...
function Location() {
  ...
  const googleMapLink = "https://www.google.com/maps/place/Mrs.+Baker's+Restaurant+%26+Pastry+Shop+Vizcaya/@16.4852522,121.1538953,17z/data=!3m1!4b1!4m6!3m5!1s0x33904411520b787d:0x8804745331bae45e!8m2!3d16.4852522!4d121.156084!16s%2Fg%2F1tdbt4l8";
    ...
    <div className='main'>
      ...
      <Link to={googleMapLink} className='link'>
        <div style={{ display: 'flex', alignItems: 'center' }}>
          ...
          <span>National Highway DTM. Nueva Vizcaya, Bayombong, Luzon 3700 Philippines</span>
        </div>
      </Link>
    </div>
  );
